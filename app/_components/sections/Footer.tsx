  ...
  return (
    <footer>
      ...
      <div className="bg-primary px-4 py-8">
        <div className="mx-auto grid max-w-[1320px] grid-cols-1 justify-items-center gap-y-8 text-lg font-medium text-white sm:grid-cols-2 sm:justify-start lg:grid-cols-4 lg:gap-y-0">
        ...
        <div className="mx-auto mt-6 flex max-w-[1320px] flex-col gap-8 text-center text-lg font-medium text-white">
