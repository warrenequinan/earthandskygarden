...
const Offer = () => {
  return (
    <section className="flex justify-center pb-[80px] pt-16 sm:pt-[120px] md:pb-[152px]">
      <div className="max-w-[1320px] flex-1 px-4 xl:px-0">
        ...
        <div className="mt-[108px] flex flex-col gap-4 sm:gap-8 lg:flex-row lg:items-center">
          <div className="group relative flex flex-1 flex-col items-center justify-center rounded-[5px] bg-muted-200 px-6 py-20 text-center transition-all duration-300 hover:scale-105 sm:pb-[70px] sm:pt-[100px]">
            <div className="absolute left-0 right-0 top-0 flex items-center justify-center">
              <div className="-mt-[60px] flex h-24 w-24 items-center justify-center rounded-full bg-white sm:-mt-[70px] sm:h-[120px] sm:w-[120px]">
                <div className="relative h-14 w-14 sm:h-[60px] sm:w-[60px]">
                  <Image
                    src={leafIcon}
                    alt="eas leaf icon"
                    fill
            ...
            <h5 className="mb-2 text-2xl font-black uppercase italic leading-[32.8px] text-primary sm:text-[28px]">
              Farm-fresh harvest
            </h5>
            <Description align="center" className="max-w-[330px]">
          ...
          <div className="group relative flex flex-1 flex-col items-center justify-center rounded-[5px] bg-primary px-6 py-20 text-center transition-all duration-300 hover:scale-105 sm:pb-[115px] sm:pt-[115px]">
            ...
            <h5 className="mb-2 text-2xl font-black uppercase italic leading-[32.8px] text-white sm:text-[28px]">
              Best Quality
            </h5>
          ...
          <div className="group relative flex flex-1 flex-col items-center justify-center rounded-[5px] bg-muted-200 px-6 py-20 text-center transition-all duration-300 hover:scale-105 sm:pb-[70px] sm:pt-[100px]">
            <div className="absolute left-0 right-0 top-0 flex items-center justify-center">
              <div className="-mt-[60px] flex h-24 w-24 items-center justify-center rounded-full bg-white sm:-mt-[70px] sm:h-[120px] sm:w-[120px]">
                <div className="relative h-14 w-14 overflow-hidden sm:h-[60px] sm:w-[60px]">
                  <Image
                    src={truckIcon}
                    alt="eas truck icon"
                    fill
